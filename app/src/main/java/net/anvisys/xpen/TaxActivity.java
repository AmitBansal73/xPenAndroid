...
public class TaxActivity extends AppCompatActivity {
    ...
    {
        try {
            tdsProgressBar.setVisibility(View.VISIBLE);
                    ...
                    try {
                        ...
                        if(remarks.matches("NoData"))
                        {
                           ...
                           // String trans_date = jObj.getString("TransactionDate");
                            ...
                            tdsPayable.setText("Payble\n"+currFormat.format(tds_payable));
                           // tdsPaid.setText("Paid\n"+currFormat.format(tds_paid));
                            previousTDS.setText("Previous\n"+currFormat.format(tds_previous));
                            currentTDS.setText("Current\n"+currFormat.format(tds_deducted));
                            penalty.setText("Penalty\n"+currFormat.format(tds_penalty));
                        }
                    }
                ...
                public void onResponse(JSONObject jObj) {
                    ...
                    try {
                        ...
                        if(remarks.matches("NoData"))
                        {
                            ...
                            payableGST.setText("Payble\n"+currFormat.format(gst_Payable));
                            paidGST.setText("Paid\n"+currFormat.format(gst_paid));
                            previousGST.setText("Previous due\n"+currFormat.format(previous_due));
                            currentGST.setText("Received\n"+currFormat.format(gst_received));
                            penaltyGST.setText("Penalty\n"+currFormat.format(penalty));
                        }
                    }
