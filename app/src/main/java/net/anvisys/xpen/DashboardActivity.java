...
public class DashboardActivity extends AppCompatActivity implements ListenerInterface, ExpenseTypeListener {
    ...
    View viewActivityActions,viewProjectActions,ExpManager,personal,managerExp,viewPersonalExp,viewCreateActivity;
    ExpenseTypeTabAdapter expenseTypeadapter;
    ExpTypeAdapter expTypeAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // viewCreateActivity = findViewById(R.id.viewCreateActivity);
       ...
       // viewPager.setAdapter(expTypeAdapter);
    ...
    public void onToggleClicked(View view) {
        if(((ToggleButton) view).isChecked()) {
           ...
           txtInProgCount.setText("No of activity: 5");
           txtInProgress.setText(currFormat.format(450000));
           txtApprovedCount.setText("No of activity: 2");
           txtApproved.setText(currFormat.format(230000));
           txtSubCount.setText("No of activity: 4");
           txtSubmitted.setText(currFormat.format(100000));
            CreateExpenseChart();

        } else {
            // handle toggle off
            ExpenseStatus.setText("Project Expense");
            txtInProgCount.setText("No of activity: 6");
            txtInProgress.setText(currFormat.format(800000));
            txtApprovedCount.setText("No of activity: 3");
            txtApproved.setText(currFormat.format(530000));
            txtSubCount.setText("No of activity: 2");
            txtSubmitted.setText(currFormat.format(75000));
            CreateExpenseChart();
    ...
    class ExpTypeAdapter extends FragmentStatePagerAdapter {
        RadioGroup radioGroup;
        public ExpTypeAdapter(FragmentManager fm) {
            super(fm);
        }
        ...
        public Fragment getItem(int position) {
            if(rbActivity.isChecked()){
                ...
                activityFragment.listener = DashboardActivity.this;
                return activityFragment;
            }else if(rbProject.isChecked()){
                ProjectFragment projectFragment = new ProjectFragment();
                projectFragment.listener = DashboardActivity.this;
